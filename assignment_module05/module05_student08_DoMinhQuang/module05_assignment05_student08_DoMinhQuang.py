...
def infinite_loop3():
    # Tạo một đối tượng lặp lại vô hạn, tuy nhiên em chưa rõ chức năng của các tham số, do ta có thể đổi chỗ True và False
    infinite = iter(lambda: False, True)
...
def infinite_loop4():
    for i in itertools.count(): #Do tò mò nên em thử dùng itertools.count() mà không truyền tham số để xem nó đếm cái gì, và kết quả
        print(i)              #là một vòng lặp vô hạn
