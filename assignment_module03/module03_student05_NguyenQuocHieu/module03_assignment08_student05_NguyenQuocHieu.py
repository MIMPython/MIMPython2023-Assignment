...
class Database:
    ...
    def __init__(self) -> None:
        self.path = "./module03_student05_NguyenQuocHieu/additionFolder/module03_assignment07_student05_NguyenQuocHieu_accounts.json"
...
class Bank:
    ...
    def __init__(self, username: str) -> None:
        self.path = "./module03_student05_NguyenQuocHieu/additionFolder/module03_assignment07_student05_NguyenQuocHieu_bank.json"
        self.handleConflict()
    ...
    def handleConflict(self) -> None:
        ...
        """
        accountPath = "./module03_student05_NguyenQuocHieu/additionFolder/module03_assignment07_student05_NguyenQuocHieu_accounts.json"
